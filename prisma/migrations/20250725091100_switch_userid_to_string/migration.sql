...
-- AlterTable
ALTER TABLE "FocusSession" ALTER COLUMN "userId" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "Mood" ALTER COLUMN "userId" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "Reflection" ALTER COLUMN "userId" SET DATA TYPE TEXT;
